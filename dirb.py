...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(usage='%(prog)s [options] <url>',
                                     ...
                                     epilog=dedent('''Examples:
                                                      python dirbuster.py  -c "200, 301,        401" -w "wordlist.txt" -e "html,php,py" https://codereview.stackexchange.com:443/questions'''))
...
if __name__ == '__main__':
    url, response_codes, wordlist, file_extensions = parse_arguments()
